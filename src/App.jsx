import pingLogo from "./assets/ping-coming-soon-page-master/images/logo.svg";
import illustration from "./assets/ping-coming-soon-page-master/images/illustration-dashboard.png";
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <div className="flex flex-row mb-6">
              <svg
                ...
                stroke="#507cf4"
                fill="#507cf4"
                className=" rounded-full border p-2 cursor-pointer hover:scale-125 duration-300"
              >
              ...
              <svg
                ...
                stroke="#507cf4"
                fill="#507cf4"
                className=" rounded-full border p-2 mx-3 cursor-pointer hover:scale-125 duration-300"
              >
